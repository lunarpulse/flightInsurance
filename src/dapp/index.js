...
(async () => {
	...
	let contract = new Contract('localhost', () => {
		...
		DOM.elid('pay').addEventListener('click', () => {
			...
			contract.buy(price, departureDate, (error, result) => {
				console.log("Insurance purchased with", price);
				display('Oracles', 'Trigger oracles', [{ label: 'Inssurance Detail', error: "", value: "Flight Name: " + fname + " | Departure Date: " + fdate + " | Assurance Paid: " + price + " ether" + " | Paid on Delay: " + price * 1.5 + " ether" }], "display-flight", "display-detail");
			});
		});
